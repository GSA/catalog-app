...
test:
	docker-compose -f docker-compose.yml -f docker-compose.test.yml build python-test
	docker-compose -f docker-compose.yml -f docker-compose.test.yml up --abort-on-container-exit python-test
