...
# This script installs some necessary .deb dependencies and then
# installs binary .whls for the packages specified in
# vendor-requirements.txt into the "vendor" directory.
